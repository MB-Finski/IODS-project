...
## An interactive scatter plot matrix

***

Here's an interactive scatter plot matrix based on HTML widgets:

***

```{r}
#To install scatterMatrixD3, uncomment the following two lines:
##install.packages("devtools")
##devtools::install_github("jcizel/scatterMatrixD3")

#library(scatterMatrixD3)
#scatterMatrix(Boston,height = 30,width = 1)
library(pairsD3)
pairsD3(Boston, big = TRUE,width = 1200)
```
...
pairsD3(  x = boston_scaled,
          group = kmeans(boston_scaled, 2)$cluster,
          big = TRUE,
          width = 1200)
````
***
